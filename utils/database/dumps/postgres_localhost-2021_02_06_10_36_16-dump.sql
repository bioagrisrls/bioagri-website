...
--
-- Name: shop_auth; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.shop_auth OWNER TO admin;
...
--
-- Data for Name: shop_auth; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- Name: shop_auth shop_auth_pk; Type: CONSTRAINT; Schema: public; Owner: admin
--
